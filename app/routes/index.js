...
export default (app) => {
  ...
  categoryRoutes.get('/all', requireAuth, CategoryController.getAllCategories);
  categoryRoutes.get('/detail/:categoryId', requireAuth, CategoryController.getAllDetails);
};
